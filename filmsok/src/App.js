...
function App() {
  ...
  async function info(sok) {
    const response = await fetch(`https://www.omdbapi.com/?apikey=b56c90e7&s=${sok}`);    //forelesning fra foreleser om async og API-behandling 21/24/28.02 samt webtricks
